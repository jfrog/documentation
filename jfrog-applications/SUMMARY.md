...
* [IDE](ide/README.md)
  * [Visual Studio Code](ide/jfrog-security-in-your-ide/visual-studio-code/README.md)
    ...
    * [Behind the Scenes](jfrog-applications/ide/visual-studio-code/behind-the-scenes.md)
    * [Extension Settings](jfrog-applications/ide/visual-studio-code/extension-settings.md)
    * [Xray Policies and Watches](jfrog-applications/ide/visual-studio-code/xray-policies-and-watches.md)
  ...
  * [Jetbrains IDEs](jfrog-applications/ide/jetbrains-ides/README.md)
    ...
    * [Android Studio Support for JCEF](jfrog-applications/ide/jetbrains-ides/android-studio-support-for-jcef.md)
...
* [Frogbot](frogbot/README.md)
  * [Get Started](frogbot/get-started/README.md)
    ...
    * [Frogbot Configuration](jfrog-applications/frogbot/get-started/frogbot-configuration.md)
    * [Setting Frogbot on GitHub Repositories](jfrog-applications/frogbot/get-started/setting-frogbot-on-github-repositories.md)
    * [Set up Frogbot Using Jenkins](jfrog-applications/frogbot/get-started/set-up-frogbot-using-jenkins.md)
    * [Installing Frogbot on JFrog Pipelines](jfrog-applications/frogbot/get-started/installing-frogbot-on-jfrog-pipelines.md)
    * [Installing Frogbot on GitLab Repositories](jfrog-applications/frogbot/get-started/installing-frogbot-on-gitlab-repositories.md)
    * [Installing Frogbot on Azure  Repositories](jfrog-applications/frogbot/get-started/installing-frogbot-on-azure-repositories.md)
