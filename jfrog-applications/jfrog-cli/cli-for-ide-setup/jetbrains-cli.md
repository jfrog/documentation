...
The JFrog CLI JetBrains command provides automated configuration for all JetBrains IDEs to use JFrog Artifactory as the plugin repository source. This enables organizations to centrally manage, curate, and distribute JetBrains plugins through their private Artifactory repositories.
