...
| --working-dirs        | <p>[Optional]<br><br>A comma-separated list of relative working directories, to determine the audit targets locations.</p> If not specified, a recursive scan is triggered from the root directory of the project.                                                                                                                                                                                                                                      |
