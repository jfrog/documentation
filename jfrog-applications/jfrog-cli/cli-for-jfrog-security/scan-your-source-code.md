...
| --licenses            | <p>[Optional]<br>Set if you'd also like the list of licenses to be displayed.</p>                                                                                                                                                                                                                                                                       |
...
| --exclusions          | <p>[Default: *.git*;*node_modules*;*target*;*venv*;*test*]<br>List of exclusions separated by semicolons, utilized to skip sub-projects from undergoing an audit. These exclusions may incorporate the * and ? wildcards.</p>                                                                                                                                 |
...
| --go                  | <p>[Optional]<br>Set to true to request audit for a Go project.</p>                                                                                                                                                                                                                                                                                     |
| --gradle              | <p>[Optional]<br>Set to true to request audit for a Gradle project.</p>                                                                                                                                                                                                                                                                                 |
| --mvn                 | <p>[Optional]<br>Set to true to request audit for a Maven project.</p>                                                                                                                                                                                                                                                                                  |
| --npm                 | <p>[Optional]<br>Set to true to request audit for a npm project.</p>                                                                                                                                                                                                                                                                                    |
| --pnpm                | <p>[Optional]<br>Set to true to request audit for a pnpm project.</p>                                                                                                                                                                                                                                                                                   |
| --nuget               | <p>[Optional]<br>Set to true to request audit for a .Net project.</p>                                                                                                                                                                                                                                                                                   |
| --pip                 | <p>[Optional]<br>Set to true to request audit for a Pip project.</p>                                                                                                                                                                                                                                                                                    |
| --pipenv              | <p>[Optional]<br>Set to true to request audit for a Pipenv project.</p>                                                                                                                                                                                                                                                                                 |
| --yarn                | <p>[Optional]<br>Set to true to request audit for a Yarn project.</p>                                                                                                                                                                                                                                                                                   |
