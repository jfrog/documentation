# Execute a manual worker

## Overview

Execute a GENERIC_EVENT worker.
...
Execute a manual worker initialized in the current directory, with a payload located in a file named `payload.json` from the same directory.
